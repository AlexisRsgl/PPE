    ...
    <div class="container">
        <nav class="side-nav">
            <ul class="nav-menu">
                ...
                @endif
                @if($role == '1' ||$role ==  '4')
                    <li class="nav-item active"><a href="./vehicule"><i class="fas fa-file-alt"></i><span class="menu-text">Gestion des véhicules</span></a></li>
                @endif
                @if($role == '1' ||$role ==  '4')
...
<?php $count = 0; ?>
            @foreach ($tableauDeVoiture as $car)
                ...
                @if(isset($car->mark) && $car->agency_id != null)
            <tr>
                <td>{{ $car->mark }} </td>
                <td>{{ $car->model }}</td>
                ...
                <td>{{ $agence->location }}</td>
                    @elseif($car->agency_id == null && $count == 0)
                        <?php $count ++; ?>
                        <td> </td>
                        <td> </td>
                    @endif
...
<div class="login-popup">
    <div class="form-popup" id="popupForm">
        <form action="{{ route("creerVehicule") }}" class="form-container">
...
<div class="login-popup">
    <div class="form-popup" id="popupModifForm">
        <form action="{{ route("modifierVehicule") }}" class="form-container">
